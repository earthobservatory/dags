...
with DAG(
    ...
    set_variable_task >> prepare_directory >> get_dem >> update_download_config >> download >> symlink >> fpm1_response_setup >> auto_control_run1 >> auto_control_run3 >> send_slack >> update_job_status >> cleanup_task