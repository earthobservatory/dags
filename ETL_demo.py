...
with DAG(
    ...
    get_dem = SSHOperator(
        task_id="get_json_from_website.sh",
        ssh_conn_id='ssh',
    ...
    auto_control_run2x5= SSHOperator(
        task_id="04_transform_run2x5.sh",
        ssh_conn_id='ssh',
    ...
    prepare_directory >> get_dem >> update_download_config >> download >> symlink >> dpm2_response_setup >> auto_control_run1 >> post_run6_geocode_series >> merge_fpm2_geo_files >> send_slack
    auto_control_run1 >> auto_control_run2 >> post_run6_geocode_series
    auto_control_run1 >> auto_control_run2x5 >> post_run6_geocode_series
    auto_control_run1 >> auto_control_run3 >> post_run6_geocode_series
    auto_control_run1 >> auto_control_run4 >> post_run6_geocode_series
    auto_control_run1 >> auto_control_run5 >> post_run6_geocode_series
    auto_control_run1 >> auto_control_run6 >> post_run6_geocode_series
    auto_control_run1 >> auto_control_run7 >> post_run6_geocode_series